...
#define KEY_MOD_LALT   					0x04			/* Left alternate */
#define KEY_MOD_LMETA  					0x08			/* Left meta */
#define KEY_MOD_RCTRL  					0x10			/* Right control */
#define KEY_MOD_RSHIFT 					0x20			/* Right shift */
#define KEY_MOD_RALT   					0x40			/* Right alternate */
#define KEY_MOD_RMETA  					0x80			/* Right meta */
/**
...
#define KEY_ERR_OVF 					0x01 			/* Keyboard Error Roll Over - used for all slots if
														too many keys are pressed ("Phantom key") */
